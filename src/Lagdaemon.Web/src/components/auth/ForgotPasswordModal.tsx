      ...
      <div className="modal auth-modal" role="dialog" aria-modal="true" aria-label="Reset password">
        ...
        {!successEmail && (
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <button type="submit" className="primary-action auth-button" disabled={isLoading || !email}>
        ...
        {!successEmail && (
          <div className="auth-modal-footer">
            ...
            <button type="button" className="auth-link" onClick={() => { setError(null); setEmail(''); onSwitchToLogin() }}>
              Sign in
            </button>
          </div>
        )}
