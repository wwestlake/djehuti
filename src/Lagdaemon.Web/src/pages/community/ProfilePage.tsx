...
import type { UserProfile, UpdateProfileInput } from '../../api/profileApi'
    ...
    <div className="community-page profile-page">
      <div className="profile-header">
        ...
        <div className="profile-info">
          ...
          {profile?.website && (
            <a className="profile-website" href={profile.website} target="_blank" rel="noreferrer">{profile.website}</a>
          )}
        </div>
